...
export default function Next() {
  ...
  return (
    <Aside>
      <section className="flex flex-col items-center justify-center w-full h-screen sm:h-full bg-white overflow-scroll">
        <ToastContainer
          bodyClassName={"text-sm font-bold text-gray-900 z-50"}
        />
        ...
        {loading ? (
          ...
          <div className="h-full w-full flex flex-col">
            <h1 className="text-2xl text-gray-900 font-bold mb-2 py-5 cursor-pointer w-full text-center">
              Abrir novo chamado
            </h1>
            <form
            ...
            >
              <div className="flex flex-row items-center justify-center flex-wrap">
                <div className="p-5 gap-2 flex flex-col h-96 sm:h-80 ml-5 sm:ml-0 md:ml-0">
                ...
                <div className="p-5 sm:p-2 flex flex-col gap-2 h-96 sm:h-full mr-5 sm:mr-0 md:mr-0">
                  <div className="flex flex-col gap-1">
                    <div className="flex flex-row justify-between items-center font-light">
                      <label className="text-xs font-bold text-gray-900">
                        Titulo
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <textarea
                      ...
                      className={`border border-gray-300 rounded-md px-2 py-1 w-96 h-48 sm:h-32 min-h-full focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-transparent resize-none leading-relaxed text-sm
                        ${
                          errors.description
                            ? "focus:ring-red-500 border-red-500"
                            : "focus:ring-gray-500"
            ...
            <div className="py-5 w-full flex flex-col justify-center items-center sm:h-14">
